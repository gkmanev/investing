...
For tables that compare or rank ticker-based ideas, use this column order whenever the relevant fields are available: **Rank**, **Ticker**, **Price**, **Strike**, **Expiration / DTE**, **Delta**, **IV %**, **Premium received**, **ROI %**, **Cash required**, **Breakeven**, **Downside buffer %**, **Contracts affordable**, **Estimated monthly income**, **RSI**, **Stock quality score**. When both expiration and DTE are available, combine them in the single **Expiration / DTE** column (for example, `2026-08-21 (30 DTE)`). Keep **Stock quality score** as the final column, immediately after RSI when RSI is available. Omit option-specific columns only when the tool did not return a value for that metric; do not move the mandatory price, RSI, or stock quality score columns.
